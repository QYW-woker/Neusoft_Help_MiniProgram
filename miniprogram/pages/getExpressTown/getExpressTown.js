...
Page({
    ...
    data: {
        typeList: [{
                name: '小件',
                tips: '小件: 文件接或衣服袋子大小，小于1公斤, 价格1.5元',
                money: 1.5,
            },
            {
                name: '中件',
                tips: '中件: 鞋服盒子大小的快件，或1-3公斤物品, 价格2.7元',
                money: 2.7,
            },
            {
                name: '大件',
                tips: '大件: 四个鞋盒大小,或 3-6公斤物品，价格5.5元',
                money: 5.5,
            },
            {
                name: '特大件',
                tips: '特大件: 行李箱大小,或 6以上公斤物品，价格9.9元以上',
                money: 9.9,
            }
        ],
        typeNow: 0,
    ...
    selectAddress() {
        wx.setStorageSync('urlNow', 'getExpressTown');
        wx.navigateTo({
